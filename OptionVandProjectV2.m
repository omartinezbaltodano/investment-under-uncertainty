function [P VP FP] = OptionVandProjectV2(Pstar,r,mu,alpha,sigma,C,I)
%--------------------------------------------------------------------------
% Purpose  : Gives the value of a project-I and the value of an option to
%            invest for a scalar variable of price pstar
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% Output   : VP    : 1x1 The value of the Project - Initial Investment
%            FP    : 1x1 The value of the option to Invest
%            P     : 1x1 Vector of prices 
%--------------------------------------------------------------------------
